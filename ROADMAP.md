...
The first DM Huddle slice uses a shared join control with audio, screen sharing, and camera video. Ringing, invitations, and missed-call notifications follow separately. The inbox starts with new messaging and work events, plus native event invitations, updates, cancellations, and reminders; agent and GitHub sources follow their integrations.
